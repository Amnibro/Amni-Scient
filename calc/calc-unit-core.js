...
(function () {
  ...
  var UCORE = {
    DIMS: DIMS,
    tables: { LEN_TO_MM: L, AREA_TO_MM2: A, PRESS_TO_MPA: P, FORCE_TO_N: FRCX, TORQUE_TO_NM: TQ, FLOW_TO_M3S: Q, POWER_TO_W: PW, VEL_TO_MS: VEL, MASS_TO_KG: MS, INERTIA_TO_MM4: INR },
    factor: factor, conv: conv, toBase: toBase, fromBase: fromBase, tempConv: tconv, principal3: principal3, VERSION: '5.20.0'
  };

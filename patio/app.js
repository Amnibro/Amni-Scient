...
import { initPermits, updatePermits } from './codes.js?v=126'
import { initMapTrace, sitePlanSVG, cropForPlan, mapPlanSnapshot } from './maptrace.js?v=126'
import { initAutoDetect } from './autodetect.js?v=126'
...
const wasm = await WebAssembly.instantiateStreaming(fetch('patio_core.wasm?v=126'))

...
import { initPermits, updatePermits } from './codes.js?v=125'
import { initMapTrace, sitePlanSVG, cropForPlan, mapPlanSnapshot } from './maptrace.js?v=125'
import { initAutoDetect } from './autodetect.js?v=125'
...
const wasm = await WebAssembly.instantiateStreaming(fetch('patio_core.wasm?v=125'))

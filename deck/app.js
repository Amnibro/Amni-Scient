...
import { initPermits, updatePermits } from './codes.js?v=263'
import { initMapTrace, sitePlanSVG, cropForPlan, mapPlanSnapshot } from './maptrace.js?v=263'
import { initAutoDetect } from './autodetect.js?v=263'
...
const wasmReady = fetch('deck_core.wasm?v=263').then(r => r.arrayBuffer()).then(b => WebAssembly.instantiate(b, {})).then(w => core = w.instance.exports)

...
async function load() {
  ...
  console.time('Cluster layouts');bookPos=computeBookLayout();kindPos=computeKindLayout();degreePos=computeDegreeLayout();flatPos=computeFlatLayout();console.timeEnd('Cluster layouts');

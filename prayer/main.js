...
const WEBLLM_DEFAULTS={enabled:false,model:IS_MOBILE?'Qwen3-0.6B-q4f16_1-MLC':'Qwen2.5-3B-Instruct-q4f16_1-MLC'};
...
const SACRED_WORDS=['Jesus','Jesu','Jesum','Iesu','Iesus','Christ','Christus','Christe','Christi','Christum','Maria','Mariae','Mariam','Mary','Mother','Virgin','Queen','Regina','Mater','Virgo','Genetrix','Deus','Dei','Deum','Deo','Domine','Dominus','Dominum','Domini','God','Lord','Spiritus','Spirit','Father','Patris','Pater','Patrem','Filii','Filium','Filius','Son','Son\u2019s','Sancti','Sanctus','Holy','Trinity','Michael','Archangel'];

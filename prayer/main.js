...
function ensureLayout(m){
  ...
  if((m==='solar'||m==='golden'||m==='cross'||m==='iam')&&!solarPos){console.time('Solar lazy');solarPos=computeSolarLayout('solar');goldenPos=computeSolarLayout('golden');crossPos=computeSolarLayout('cross');iamPos=computeSolarLayout('iam');console.timeEnd('Solar lazy');}
